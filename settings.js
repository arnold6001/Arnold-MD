...
module.exports = {
  ...
  OWNER_NUMBER: settings.OWNER_NUMBER || process.env.OWNER_NUMBER || "254703110780", // Owner's WhatsApp number
  OWNER_NAME: getConfig("OWNER_NAME") || process.env.OWNER_NAME || "Arnold Chirchir", // Owner's name
  DEV: process.env.DEV || "254703110780", // Developer's contact
  DEVELOPER_NUMBER: '254703110780@s.whatsapp.net', // Developer's WhatsApp ID
